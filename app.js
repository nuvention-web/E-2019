...
//   res.setHeader("Access-Control-Allow-Origin", "https://loop-backend-server.herokuapp.com/");
//   res.setHeader(
...
//         for(i = 0; i < nRow; i++) {
//           for(j = 0; j < nCol; j++) {
//             if (iter < touchList.length){
//               var eachItem ={}
//               eachItem.displayvalue = touchList[iter].receiver;
//               eachItem.value = touchList[iter].connections.toString();
//               var tempRowid = i+1
//               eachItem.rowid = tempRowid.toString();
//               var tempColid = j+1
//               eachItem.columnid = tempColid.toString();
...
//             else if (iter < n){
//               var eachItem ={}
//               eachItem.displayvalue = inEffFriends[iter - touchList.length];
//               eachItem.value = "0";
//               var tempRowid = i+1
//               eachItem.rowid = tempRowid.toString();
//               var tempColid = j+1
...
// get('/api/loops/users/heatmap', function(req, res){
//   options = {
//     "metric": "prerak",
//     "start_rel": "1_Y",
//     "tags": {
...
//  }
//  queryTS(options, function(err, res2){
//     //the result from the KairosDB and the data is of format of KairosDB
//     console.log(res2)
//     res.send(res2)
//   })
// })
...
// app.get('/api/loops/users/heatmap', function(req, res){
//   fetch('http://3.89.40.83:8082/api/v1/datapoints/query', {
//     method: 'post',
//     body: options,
//   })
//     .then((response)=>{
