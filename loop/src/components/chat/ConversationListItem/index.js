  ...
  render() {
    ...
    return (
      <div className="messenger">
          ...
          <div className="conversation-list">
            ...
            {this.props.conversations.map(conversation => (
              <div
                ...
                onClick={event => this.handleChange(event, conversation)}
              >
                <img
        ...
        {this.props.conversations !== undefined &&this.props.conversations.length !==0 ? (
          <div className="scrollable content">
          {Object.entries(this.state.selectedUser).length === 0 ? (
            <MessageListItem data={this.props.conversations[0]} />
          ) : (
